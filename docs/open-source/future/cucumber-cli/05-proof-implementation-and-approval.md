...
> **Status:** Superseded implementation proposal; not approved

These slices and gates apply only to the deferred Cucumber/CLI design and must
not be used to start implementation. The normative Gate 3 proof is maintained
under `docs/open-source/v0.1/gate-3/`.
